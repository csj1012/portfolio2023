...
export default function Intro() {
  const lighten = 'linear-gradient(rgba(67, 114, 84, 0.21), rgba(67, 114, 84, 0.21))'
  const backgroundStyle = `${lighten}, ${ComputedBg()}`
  ...
  return (
    <section className="intro">    
      ...
      <article className="intro__copy">
        <p className="intro__copy--special">Hello! I&#39;m Chelsie, a developer with <span style={{backgroundImage: backgroundStyle}}>a love for front end</span>. A little about  me:</p>
        <p>My journey through code & design has been shaped by the continuous joy I&#39;ve found in crafting experiences that evoke emotion and foster a sense of connection—a passion kindled from an early start with coding at age ten.</p>
